...
export default function App() {
  ...
  const agentClosedData = {
    ...
    datasets: [{
      label: 'Leads Closed',
      data: a.map(x => d.filter(lead => lead.salesAgent?.id === x.id && lead.status === 'Closed').length),
            ...
            <div className="card mb-4">
              ...
              <div className="card-body">
                ...
                <div className="text-center mt-3">
                  <p className="mb-1"><strong>Closed:</strong> {closedLeads} leads</p>
                  <p className="mb-0"><strong>In Pipeline:</strong> {pipelineLeads} leads</p>
                </div>
              </div>
            </div>
